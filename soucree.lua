...
local function Hide(notify: boolean?)
	...
	if notify then
		if useMobilePrompt then 
			RayfieldLibrary:Notify({Title = "Interface Hidden", Content = "The interface has been hidden, you can unhide the interface by tapping '⚙️'.", Duration = 7, Image = 4400697855})
		else
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	if Settings.LoadingTitle ~= "Rayfield Interface Suite" then
		LoadingFrame.Version.Text = "Version : 2.0.0"
	end
		...
		task.spawn(function()
			while true do
				...
				RayfieldLibrary:Notify({
					Title = "System | ThangBeoHub",
					Content = "Thank You Bro Enjoy My Script? If find bug/errors contact me in telegram :@ngtanh1305",
					Duration = 7,
					Image = 4370033185,
				})
			end
			...
			KeyUI.Main.Input.InputBox.FocusLost:Connect(function()
				...
				if KeyFound then 
					...
					if Settings.KeySettings.SaveKey then
						...
						RayfieldLibrary:Notify({Title = "Key System", Content = "Key Bạn Nhập Đã Xác Nhận Thành Công !", Image = 3605522284})
					end
				else
