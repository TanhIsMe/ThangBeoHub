...
local Window = Library:CreateWindow('⚙️ThangBeoHub | BF Main🍎') -- CREATE WINDOW

local Tab = { -- CREATE TABS
    Tab_1 = Window:addTab('🏠'),
    Tab_Setting = Window:addTab('⚙️'),
    Tab_2 = Window:addTab('⚒️'),
    Tab_SubFarm = Window:addTab('⚙️⚒️'),
    Tab_3 = Window:addTab('📋'),
    Tab_Sea = Window:addTab('🌊'),
    Tab_RaceV4 = Window:addTab('🔥'),
    Tab_4 = Window:addTab('☄️'),
    Tab_Combat = Window:addTab('🗡️'),
    Tab_5 = Window:addTab('💨📱'),
    Tab_6 = Window:addTab('🛒'),
    Tab_7 = Window:addTab('🖥️')
...
FastAttackSelected = "0.0 (Default)"
...
spawn(function()
    while task.wait() do
        if FastAttackSelected == "0.0(Risk)" then
            FastAttackDelay = 0.1
    ...
    while task.wait() do
        if MobileFastAttack then
            ...
            pcall(function()
                ...
                activeController.hitboxMagnitude = 999999999999999
